...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[linear-gradient(135deg,#7a99db_0%,#cbd6f6_45%,#cbd6f6_100%)] dark:bg-[linear-gradient(135deg,#0c051f_0%,#020005_45%,#020005_100%)] text-slate-800 dark:text-slate-100 flex flex-col font-sans overflow-x-hidden selection:bg-violet-500/20 relative transition-colors duration-300">
      ...
      <div className="fixed top-[10%] left-[15%] w-[600px] h-[600px] bg-violet-500 rounded-full mix-blend-multiply filter blur-[130px] opacity-20 dark:opacity-25 pointer-events-none" />
      <div className="fixed bottom-[5%] right-[10%] w-[700px] h-[700px] bg-blue-450 rounded-full mix-blend-multiply filter blur-[150px] opacity-20 dark:opacity-25 pointer-events-none" />
      <div className="fixed top-[40%] left-[40%] w-[500px] h-[500px] bg-pink-400 rounded-full mix-blend-multiply filter blur-[120px] opacity-10 dark:opacity-15 pointer-events-none" />
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 backdrop-blur-lg bg-white/10 dark:bg-slate-950/20 border-b border-white/20 dark:border-white/10 transition-colors duration-300">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 bg-slate-950 dark:bg-violet-600 text-white rounded-xl flex items-center justify-center font-bold shadow-md border border-white/10">
            IF
          </div>
        ...
        <div className="flex items-center gap-4">
          <ThemeToggle />
          <Link href="/dashboard" className="text-sm font-bold text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white transition-colors">
            Sign In
          </Link>
          <Link 
            href="/dashboard" 
      ...
      <main className="flex-1 flex flex-col items-center pt-36 pb-20 px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mt-12 relative z-10">
          ...
          <p className="text-lg md:text-xl text-slate-755/90 dark:text-slate-400 mb-10 max-w-2xl mx-auto leading-relaxed font-medium">
        ...
        <div className="w-full max-w-6xl mt-24 relative z-10 glass-card p-3 md:p-5 shadow-[0_20px_50px_-12px_rgba(30,41,59,0.04)] border-none">
          <div className="w-full aspect-[16/9] bg-white/20 dark:bg-slate-950/60 rounded-2xl overflow-hidden border border-white/45 dark:border-white/5 flex flex-col items-center justify-center relative shadow-sm">
            ...
            <Rocket size={48} className="text-slate-700/60 dark:text-violet-400/80 animate-bounce mb-3" />
            <h3 className="font-extrabold text-lg text-slate-850 dark:text-white">Launch IntelFlow Console</h3>
            <p className="text-slate-500 dark:text-slate-450 text-xs font-semibold mt-1 mb-6">Open the production-grade competitor analytics workspace</p>
